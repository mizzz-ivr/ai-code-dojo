export const QUEUE_EVENTS = Object.freeze({
  ...
  CONSUMER_POLL_FAILED: 'queue.consumer.poll_failed',
  CONSUMER_PROCESSING_FAILED: 'queue.consumer.processing_failed',
  ...
  RETRY_DELAY_SCHEDULED: 'queue.retry.delay_scheduled',
  RETRY_DELAY_FAILED: 'queue.retry.delay_failed',
  ...
  OUTBOX_PUBLISH_SUCCEEDED: 'queue.outbox.publish_succeeded',
  OUTBOX_PUBLISH_FAILED: 'queue.outbox.publish_failed',
  OUTBOX_DISPATCH_COMPLETED: 'queue.outbox.dispatch_completed',
  OUTBOX_DISPATCH_FAILED: 'queue.outbox.dispatch_failed',
